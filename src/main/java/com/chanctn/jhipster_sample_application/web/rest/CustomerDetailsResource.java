...
import com.chanctn.jhipster_sample_application.service.CustomerDetailsService;
...
/**
 * REST controller for managing {@link com.chanctn.jhipster_sample_application.domain.CustomerDetails}.
 */
@RestController
@RequestMapping("/api")
public class CustomerDetailsResource {
    ...
    public Mono<List<CustomerDetails>> getAllCustomerDetails() {
        log.debug("REST request to get all CustomerDetails");
        return customerDetailsService.findAll().collectList();
    }

    /**
     * {@code GET  /customer-details} : get all the customerDetails as a stream.
     * @return the {@link Flux} of customerDetails.
     */
    @GetMapping(value = "/customer-details", produces = MediaType.APPLICATION_NDJSON_VALUE)
    public Flux<CustomerDetails> getAllCustomerDetailsAsStream() {
        log.debug("REST request to get all CustomerDetails as a stream");
    ...
    public Mono<ResponseEntity<CustomerDetails>> getCustomerDetails(@PathVariable Long id) {
    ...
    public Mono<ResponseEntity<Void>> deleteCustomerDetails(@PathVariable Long id) {
