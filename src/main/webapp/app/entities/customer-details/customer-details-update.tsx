  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.customerDetails.home.createOrEditLabel" data-cy="CustomerDetailsCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplicationApp.customerDetails.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.customerDetails.phone')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.customerDetails.addressLine1')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.customerDetails.addressLine2')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.customerDetails.city')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.customerDetails.country')}
              ...
              <ValidatedField
                ...
                name="userId"
                data-cy="user"
                label={translate('jhipsterSampleApplicationApp.customerDetails.user')}
                type="select"
                required
              >
                <option value="" key="0" />
