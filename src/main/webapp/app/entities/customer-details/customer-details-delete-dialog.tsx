...
export const CustomerDetailsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.customerDetails.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.customerDetails.delete.question" interpolate={{ id: customerDetailsEntity.id }}>
