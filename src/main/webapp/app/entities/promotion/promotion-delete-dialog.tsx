...
export const PromotionDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.promotion.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.promotion.delete.question" interpolate={{ id: promotionEntity.id }}>
