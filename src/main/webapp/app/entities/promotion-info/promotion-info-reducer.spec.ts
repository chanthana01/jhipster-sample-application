...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROMOTIONINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROMOTIONINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROMOTIONINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROMOTIONINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROMOTIONINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROMOTIONINFO actions', async () => {
      const expectedActions = [
        {
