            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.product.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('category')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.product.category">Category</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('family')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.product.family">Family</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('detail1')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.product.detail1">Detail 1</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('detail2')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.product.detail2">Detail 2</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {productList.map((product, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{product.modifyAt ? <TextFormat type="date" value={product.modifyAt} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{product.inventory ? <Link to={`inventory/${product.inventory.id}`}>{product.inventory.id}</Link> : ''}</td>
