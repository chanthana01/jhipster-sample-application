...
export const InventoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.inventory.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.inventory.delete.question" interpolate={{ id: inventoryEntity.id }}>
