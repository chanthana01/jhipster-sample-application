  ...
  return (
    <div>
      <h2 id="inventory-heading" data-cy="InventoryHeading">
        <Translate contentKey="jhipsterSampleApplicationApp.inventory.home.title">Inventories</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplicationApp.inventory.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplicationApp.inventory.home.createLabel">Create new Inventory</Translate>
          </Link>
        </div>
      </h2>
        ...
        {inventoryList && inventoryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.inventory.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.inventory.home.notFound">No Inventories found</Translate>
            </div>
          )
        )}
      </div>
