...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERINFO actions', async () => {
      const expectedActions = [
        {
